...
Write-Host "  4. Сборка ярлыка: powershell -ExecutionPolicy Bypass -File scripts\build-launcher-exe.ps1"
Write-Host "  5. Ярлык на стол: powershell -ExecutionPolicy Bypass -File scripts\create-desktop-shortcut.ps1"
Write-Host "  6. Запуск для пользователя: двойной клик cvetopt.exe (или ярлык на рабочем столе)"
